...
public class Assets implements Serializable {
	...
	public void saveToF() {
	    ...
	    try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("base5a.bin"))) {
	...
	public Assets loadFromF() {
		try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("base5a.bin"))) {
